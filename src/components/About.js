					...
					<div className="row align-items-center">
						<div className="col">
							<div style={{ textAlign: 'start' }}>
								<h1 style={{ color: 'white', fontSize: 30 }} className="mb-4">
									About Mathrix
								</h1>
								<h5 style={{ color: '#7E30E1' }} className="mb-2 text-lg">
							...
							<div style={{ textAlign: 'start' }} className="text-lg">
									...
									<div className="col-sm-8" style={{ marginRight: 20 }}>
										<div style={{ padding: 15 }}>
											<p style={{ color: '#A366FF', textAlign: 'justify', fontWeight: '900' }}>
												Lorem ipsum dolor sit amet consectetur adipisicing elit. Autem reprehenderit, sed quas ab eveniet itaque veritatis inventore libero delectus vitae! Ratione sapiente, beatae
												veniam esse itaque optio facilis incidunt animi? Voluptatem debitis soluta nobis. Maiores sed
											</p>
										</div>
									</div>
