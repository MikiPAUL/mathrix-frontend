...
const Register = () => {
    ...
    return (
        <>
            <div className="register-section" style={{backdropFilter:"blur(10)",border:"4px solid #7E30E1",boxShadow:"0 0 50px 15px #7E30E1",borderRadius:15,position:"relative",textAlign:"center",justifyContent:"center",alignItems:"center",padding:15,marginTop:100}}>
                {success ? (
                    <section>
                        <h1>Success!</h1>
                        <p>
                    ...
                    <section className="registration-field">
                        <form onSubmit={handleSubmit} style={{width:"80%"}}>
                            ...
                            <button className="buttonl" disabled={!validName || !validPass || !validConfirmPass}>REGISTER</button>
                        </form>
                    </section>
