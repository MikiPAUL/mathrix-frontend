				...
				<section className="login-field section">
					<div class="mb-3">
						<div className="username-field" style={{ flexDirection: 'row' }}>
							<input type="text" id="username form-control" placeholder="ENTER NAME" value={username} onChange={(e) => setUsername(e.target.value)} aria-describedby="emailHelp" />
					...
					<button type="submit" class="btn btn-primary buttonl">
						Submit
					</button>
					<div style={{ flexDirection: 'row', padding: 5 }}>
						<p>
							Not having an account?{' '}
							<button style={{ all: 'unset', color: '#7E30E1' }} className="hover:cursor-pointer" onClick={() => navigation('/registration')}>
								Register
							</button>
						</p>
					</div>
